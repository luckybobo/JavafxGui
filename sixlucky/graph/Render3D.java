            ...
            if (isfill) {
                for (int i = 0; i < rect3d.elementArr.length; i++) {
                    if (ceil[rect3d.elementArr[i][0]] != null && ceil[rect3d.elementArr[i][1]] != null && ceil[rect3d.elementArr[i][2]] != null)
                        render2D.absTriangle(ceil[rect3d.elementArr[i][0]], ceil[rect3d.elementArr[i][1]], ceil[rect3d.elementArr[i][2]], true, rect3d.elementColor[i]);
                }
            } else {
                for (int i = 0; i < rect3d.elementArr.length; i++) {
                    render2D.absTriangle(ceil[rect3d.elementArr[i][0]], ceil[rect3d.elementArr[i][1]], ceil[rect3d.elementArr[i][2]], false, rect3d.elementColor[i]);
                }
            }
        } finally {
            rectLock.unlock();
